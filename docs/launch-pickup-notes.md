...
- The app currently supports:
  ...
  - More screen with support, privacy notes, and launch readiness
  - Copy buttons for generated AI drafts
...
9. Set `EXPO_PUBLIC_SUPPORT_EMAIL` to the support inbox that should receive app questions.
10. Deploy the Netlify site.
11. Smoke test booking, media, AI tools, copy buttons, checklist, More screen, and mobile browser install behavior.
...
- Set `EXPO_PUBLIC_SUPPORT_EMAIL` in Netlify before sharing the app outside a tiny test group.
...
- Client guide cards now replace the placeholder how-to video links.
